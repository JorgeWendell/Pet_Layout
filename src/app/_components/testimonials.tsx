...
const testimonials = [
   ...
   {
    content: 
        "O serviço de hotel para pets foi uma experiencia incrível! Precisei viajar e fiquei tranquilo sabendo que o Thor estava sendo bem cuidado. Recebi fotos e atualizações diárias, e ele voltou para a casa super feliz! Sem dúvida, o melhor petshop da região.",
    author: "Rafael",
   ...
   {
    content: 
        "Meus gatos nunca gostaram de sair de casa, mas o atendimento nesse petshop fez toda a diferença. A equipe é muito paciente e cuidadosa, e o serviço de banho especializado para felinos foi maravilhoso! Agora sei aonde confiar o cuidado deles.",
    author: "Camila Fernandes",
    role: "Tutora da Mel e do Max (Gatos SRD)",
    image: tutor2,
   },
]
